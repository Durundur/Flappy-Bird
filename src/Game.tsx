...
function Game() {
  ...
  const drawGame = (canvasContext: CanvasRenderingContext2D) => {
    ...
    canvasContext.drawImage(
      BACKGROUND_SRC,
      groundX,
      CANVAS_HEIGHT * 0.9 - GROUND_HEIGHT,
      CANVAS_WIDTH,
      CANVAS_HEIGHT * 0.1
    );
    canvasContext.drawImage(
      BACKGROUND_SRC,
      groundX + CANVAS_WIDTH,
      CANVAS_HEIGHT * 0.9 - GROUND_HEIGHT,
      CANVAS_WIDTH,
      CANVAS_HEIGHT * 0.1
    );
    ...
    canvasContext.drawImage(
      PIPE_GREEN_INV_SRC,
      firstPipeX,
      -CANVAS_HEIGHT - PIPES_GAP + firstPipeY,
      PIPES_WIDTH,
      CANVAS_HEIGHT
    );
    canvasContext.drawImage(
    ...
    canvasContext.drawImage(
      PIPE_GREEN_INV_SRC,
      secondPipeX,
      -CANVAS_HEIGHT - PIPES_GAP + secondPipeY,
      PIPES_WIDTH,
      CANVAS_HEIGHT
    );
    canvasContext.drawImage(
    ...
    canvasContext.drawImage(
      PIPE_GREEN_INV_SRC,
      thirdPipeX,
      -CANVAS_HEIGHT - PIPES_GAP + thirdPipeY,
      PIPES_WIDTH,
      CANVAS_HEIGHT
    );
    canvasContext.drawImage(
  ...
  const checkIfGameOver = () => {
    const { x: nearestPipeX, y: nearestPipeY } = findNearestPipe(
      firstPipeX,
      secondPipeX,
      thirdPipeX,
      firstPipeY,
    ...
    if (
      ...
      birdHitbox.y + birdHitbox.height > CANVAS_HEIGHT - GROUND_HEIGHT
    ) {
      gameLoop.current?.end();
      setIsGameOver(true);
    }
